This folder contains various codes and notes that where developed during the research phase, including the present `README`. The reader can safely skip going over these.
